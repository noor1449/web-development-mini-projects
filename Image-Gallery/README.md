...
- Layout Organization: Images are grouped structurally inside nested container rows, making it easy to display wide landscape grids.
## Project Structure
```text
├── index.html       # Application layout and embedded JavaScript navigation logic
├── style.css        # The styling sheet (handling layout alignment and button positions)
└── assets/          # Local folder containing your UI buttons and display images
