...
- Custom Variations Selection: Features custom-built selector radios for picking clothing sizes (S, M, L, XL, XXL) and specific product color variations cleanly.
## Project Structure
```text
├── index.html       # Structural design, item attributes, and variant gallery logic
├── style.css        # Layout structure sheet (Note: Ensure your styles define flex positions)
└── assets/          # Internal media folder housing variants (`image1.png`, `image2.png`, etc.)
